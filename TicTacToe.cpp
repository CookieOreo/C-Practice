/*
Author: Raymond Chen 
Description: Tic Tac Toe. Fri June 19th 2015
...
int main()
{
    ...
    cout << "a) Play against a human[Player 2]" << endl;
	cout << "b) Play against a computer"
	cin >> choice;
    ...
    if (choice == 'a'){
	    ...
	    {
	        display_board();
	        cout << endl << endl << "Player 1 [X] Wins! Game Over!" << endl;
	    }
	    else if (turn == 'X' && !draw)
	    {
	        display_board();
	        cout << endl << endl << "Player 2 [O] Wins! Game Over!" << endl;
	    }
	    else
	    {
	        display_board();
	        cout << endl << endl << "It's a draw! Game Over!" << endl;
	    }
	}
	else if (choice == 'b'){
